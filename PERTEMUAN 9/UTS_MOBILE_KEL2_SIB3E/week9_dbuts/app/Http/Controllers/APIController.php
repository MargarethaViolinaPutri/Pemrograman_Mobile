...
class APIController extends Controller
{
  /**
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => 'Berhasil menyimpan data', 'data' => $save]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return response()->json(['message' => 'Berhasil mengubah data', 'data' => $data]);
    }
     ...
     */
     ...
     public function countRespondentsByGender(Request $request)
     {
         ...
         return response()->json(['message' => 'Jumlah responden berdasarkan jenis kelamin ' . $Gender, 'data' => $rowCount]);
     }
     ...
     */
     ...
     public function countRespondentsByCountry(Request $request)
     {
         ...
         return response()->json(['message' => 'Jumlah responden berdasarkan nationality ' . $Nationality, 'data' => $rowCount]);
     }
     ...
     */
     ...
     public function countRespondentsByGenre(Request $request)
     {
         ...
         // Menghitung jumlah responden berdasarkan jenis genre.
         $Genre = $request->input('Genre');
         $rowCount = week9_dbuts::where('Genre', $Genre)->count();
     
         return response()->json(['message' => 'Jumlah responden berdasarkan genre ' . $Genre, 'data' => $rowCount]);
     }
